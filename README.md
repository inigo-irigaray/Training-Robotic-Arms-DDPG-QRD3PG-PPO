...
<p align=justify><b>NOTE:</b> This initial deliverable is designed to meet Udacity's rubrik criteria to pass the project while I work on the final implementation of Multiprocessing for D3PG and on improvements for PPO (mostly parameter tweaking), and prepare the presentation of a more detailed report this project and README.md in blog format for my personal portfolio.</p>
