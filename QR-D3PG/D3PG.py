...
class Critic(nn.Module):
    def __init__(self, obs_size, act_size, quant, hid1=400, hid2=300, norm='layer'):
        ...
        self.net2.add_module('fc3', nn.Linear(hid2, quant))
...
class DDPGAgent:
    ...
    def update(self, sample, writer=None):
        self.iter += 1
